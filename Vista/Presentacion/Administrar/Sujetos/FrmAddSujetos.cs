...
namespace RES.FrontEnd
{
    ...
    public partial class FrmAddSujetos : Control_Agregar_Pq
    {
        
        public FrmAddSujetos(): base()
        {
            InitializeComponent();
        ...
        private void PictureLectura1_Click(object sender, EventArgs e)
        {

           
        }

        private void PictureLectura2_Click(object sender, EventArgs e)
        {
